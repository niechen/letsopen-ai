...
### Development tools
Tools for building AI-powered applications and integrating AI into existing software.

### Productivity tools
AI tools for individual productivity — writing, research, organization, automation.

### Creative tools
Open source tools for AI-generated images, audio, video, and other media.

### Data tools
Tools for preparing, cleaning, and managing data for AI systems.
